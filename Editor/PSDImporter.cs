            ...
            try
            {
                    ...
                    m_MosaicLayers == false || singleSpriteMode)
                {
                    ...
                    try
                    {
                        ...
                        FlattenImageTask.Execute(m_ExtractData, m_ImportHiddenLayers, doc.width, doc.height, image);
                        ...
                        var output = ImportTexture(ctx, image, doc.width, doc.height, spriteRects);
